...
export default function MarketingLanding() {
  return (
    <div className="mkt-landing">
      ...
      <section className="mkt-hero">
        <div className="mkt-container">
          ...
          <p className="mkt-hero-desc">
            丢掉网盘，回归点对点。基于 Hyperswarm
            的去中心化文件传输，不限速、不限量、不追踪。
          </p>
          <InstallTabs />
      ...
      <div className="mkt-container">
        <div className="mkt-screenshot-placeholder">MostBox 截图</div>
      </div>
      ...
      <section className="mkt-section">
        <div className="mkt-container">
          ...
          <p className="mkt-section-desc">
            基于 Hyperswarm
            的去中心化文件分享工具，让文件传输回归点对点，无需服务器中转。
          </p>
            ...
            {steps.map(step => (
              <div key={step.num} className="mkt-step">
                ...
                <div className="mkt-step-content">
                  <h4>{step.title}</h4>
                  <p>{step.desc}</p>
                  {step.code && <code className="mkt-code">{step.code}</code>}
                  {step.link && (
      ...
      <section className="mkt-section mkt-section-alt mkt-cta">
        <div className="mkt-container">
          ...
          <p className="mkt-cta-desc">一行命令，即刻开始分享文件。</p>
