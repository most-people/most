...
function CheckIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="#30d158" strokeWidth="1.5" strokeLinecap="square">
  ...
  return (
    <div className="install-tabs">
      ...
      <div className="tab-panel" role="tabpanel">
        ...
        <button className={`copy-btn ${copied ? 'copied' : ''}`} onClick={handleCopy} aria-label="复制命令">
