...
import { ArrowLeft, Database, Download, Moon, Sun } from 'lucide-react'
...
export default function Web3ExportPage() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .json()
      .then(setPreview)
      .catch(async err => setError(await getApiErrorMessage(err, '导出预览失败')))
  ...
  return (
    <AppShell
      ...
      headerTitle={<h2 className="header-title">用户数据导出</h2>}
      headerRight={
        <button
        ...
        <div className="web3-container narrow">
          <section className="web3-key-card">
            <div className="web3-key-card-header">
              ...
              <span className="web3-key-card-title">MostBox 元数据</span>
            </div>
