...
export default function HomePage() {
  ...
  if (mode === 'loading') {
    return (
      <div style={{
        ...
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.5, animation: 'pulse 1.5s ease-in-out infinite' }}>
  ...
  if (mode === 'app') {
    return <AppHomeMode nodeId={nodeId} />
  }
