...
export const metadata = {
  title: '架构说明 - MostBox',
  description: 'MostBox 架构说明：Hyperswarm P2P 网络、Hyperdrive 文件存储、CID 计算。',
}
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8125rem' }}>
            <thead>
              <tr style={{ borderBottom: '2px solid var(--color-border)' }}>
                <th style={{ textAlign: 'left', padding: '0.5rem 0.75rem', fontWeight: 600, fontSize: '0.75rem', color: 'var(--color-text-muted)', textTransform: 'uppercase' }}>方法</th>
                <th style={{ textAlign: 'left', padding: '0.5rem 0.75rem', fontWeight: 600, fontSize: '0.75rem', color: 'var(--color-text-muted)', textTransform: 'uppercase' }}>路径</th>
            ...
            <tbody>
              <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>GET</code></td>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>/api/files</code></td>
                <td style={{ padding: '0.5rem 0.75rem', color: 'var(--color-text-secondary)' }}>列出已发布文件</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>POST</code></td>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>/api/publish</code></td>
                <td style={{ padding: '0.5rem 0.75rem', color: 'var(--color-text-secondary)' }}>上传文件</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>POST</code></td>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>/api/download</code></td>
                <td style={{ padding: '0.5rem 0.75rem', color: 'var(--color-text-secondary)' }}>下载分享的文件</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>GET</code></td>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>/api/network</code></td>
                <td style={{ padding: '0.5rem 0.75rem', color: 'var(--color-text-secondary)' }}>网络地址信息</td>
              </tr>
              <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>WS</code></td>
                <td style={{ padding: '0.5rem 0.75rem' }}><code>/ws</code></td>
                <td style={{ padding: '0.5rem 0.75rem', color: 'var(--color-text-secondary)' }}>WebSocket 实时事件</td>
              </tr>
            </tbody>
          </table>
        </div>
