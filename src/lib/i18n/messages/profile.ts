export const zhCNProfileMessages = {
  ...
  'profile.backup.summary.trash': '回收站',
  'profile.backup.summary.channels': '频道',
  'profile.logout.backupReminder': '退出登录前，建议先备份到云端，或导出到本地，避免显示名称、头像、偏好设置和本机资料丢失。',
  ...
  'profile.backup.action.exportLocal': '导出到本地',
  'profile.backup.action.importLocal': '导入到本地',
...
export const zhTWProfileMessages = {
  ...
  'profile.backup.summary.trash': '垃圾桶',
  'profile.backup.summary.channels': '頻道',
  'profile.logout.backupReminder': '登出前，建議先備份到雲端，或匯出到本機，避免顯示名稱、頭像、偏好設定和本機資料遺失。',
  ...
  'profile.backup.action.exportLocal': '匯出到本機',
  'profile.backup.action.importLocal': '匯入到本機',
...
export const enProfileMessages = {
  ...
  'profile.backup.summary.trash': 'Trash',
  'profile.backup.summary.channels': 'Channels',
  'profile.logout.backupReminder': 'Before signing out, back up to the cloud or export locally to avoid losing display name, avatar, preferences, and local data.',
  ...
  'profile.backup.action.exportLocal': 'Export to local',
  'profile.backup.action.importLocal': 'Import to local',
