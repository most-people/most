export const zhCNProfileMessages = {
  ...
  'profile.section.backup.desc': '手动备份或恢复加密账号数据，包括知识库、文件目录、回收站和频道偏好。',
...
export const zhTWProfileMessages = {
  ...
  'profile.section.backup.desc': '手動備份或恢復加密帳號資料，包括知識庫、檔案目錄、垃圾桶和頻道偏好。',
...
export const enProfileMessages = {
  ...
  'profile.section.backup.desc': 'Manually back up or restore encrypted account data, including the knowledge base, file directories, trash, and channel preferences.',
