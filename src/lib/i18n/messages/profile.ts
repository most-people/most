export const zhCNProfileMessages = {
  ...
  'profile.logout.backupReminder':
    '退出登录前，建议先备份到本地，避免显示名称、头像、偏好设置和本机资料丢失。',
...
export const zhTWProfileMessages = {
  ...
  'profile.logout.backupReminder':
    '登出前，建議先備份到本機，避免顯示名稱、頭像、偏好設定和本機資料遺失。',
...
export const enProfileMessages = {
  ...
  'profile.logout.backupReminder':
    'Before signing out, back up locally to avoid losing display name, avatar, preferences, and local data.',
