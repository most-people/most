export const zhCNProfileMessages = {
  ...
  'profile.backup.action.exportLocal': '导出备份',
  'profile.backup.action.importLocal': '导入备份',
  ...
  'profile.backup.confirm.restoreMessage': '这会从云端恢复账号数据，可能替换本地笔记，继续吗？',
...
export const zhTWProfileMessages = {
  ...
  'profile.backup.action.exportLocal': '匯出備份',
  'profile.backup.action.importLocal': '匯入備份',
  ...
  'profile.backup.confirm.restoreMessage': '這會從雲端恢復帳號資料，可能取代本機筆記，繼續嗎？',
...
export const enProfileMessages = {
  ...
  'profile.backup.action.exportLocal': 'Export backup',
  'profile.backup.action.importLocal': 'Import backup',
  ...
  'profile.backup.confirm.restoreMessage': 'This will restore account data from the cloud and may replace local notes. Continue?',
