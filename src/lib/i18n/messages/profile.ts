export const zhCNProfileMessages = {
  ...
  'profile.section.account.desc':
    '这些信息用于聊天和工具箱里的身份展示，并会随账号备份同步。切换语言后可维护对应语言的标签。',
  ...
  'profile.backup.loginRestore.message': '这会覆盖当前本机数据。',
  ...
  'profile.toast.tagUpdated': '标签已更新',
  'profile.tag.placeholder': '输入当前语言的标签',
  'profile.tag.invalid': '标签无效或超过 50 个字符',
...
export const zhTWProfileMessages = {
  ...
  'profile.section.account.desc':
    '這些資訊用於聊天和工具箱裡的身份展示，並會隨帳號備份同步。切換語言後可維護對應語言的標籤。',
  ...
  'profile.backup.loginRestore.message': '這會覆蓋目前本機資料。',
  ...
  'profile.toast.tagUpdated': '標籤已更新',
  'profile.tag.placeholder': '輸入目前語言的標籤',
  'profile.tag.invalid': '標籤無效或超過 50 個字元',
...
export const enProfileMessages = {
  ...
  'profile.section.account.desc':
    'These details are used for identity display across chat and tools, and sync through account backup. Switch languages to maintain each localized tag.',
  ...
  'profile.backup.loginRestore.message': 'This will replace local data.',
  ...
  'profile.toast.tagUpdated': 'Tag updated',
  'profile.tag.placeholder': 'Enter the tag for this language',
  'profile.tag.invalid': 'Tag is invalid or exceeds 50 characters',
